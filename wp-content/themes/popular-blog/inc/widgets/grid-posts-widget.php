<?php
if ( ! class_exists( 'Popular_Blog_Grid_Posts_Widget' ) ) {
	/**
	 * Adds Popular Blog Grid Posts Widget.
	 */
	class Popular_Blog_Grid_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'popular_blog_grid_posts_widget',
				__( 'Popular Blog: Grid Posts Widget', 'popular-blog' ),
				$grid_posts_widget
			);
		}
