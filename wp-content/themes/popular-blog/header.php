...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary-content"><?php esc_html_e( 'Skip to content', 'popular-blog' ); ?></a>
		...
		<?php require get_template_directory() . '/inc/frontpage-sections/breaking-news.php'; ?>
